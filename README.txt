...
a persistence unit "examenGuapisacaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenGuapisaca/pom.xml":
...
artifact ("examenGuapisaca.war") is already built. You can build
